...
function genNodeListAsArray(nodes, context) {
  const multilines = nodes.length > 3 || nodes.some((n) => isArray$1(n) || !isText(n));
  context.push(`[`);
...
function compileToFunction(template, options) {
  if (!isString(template)) {
    if (template.nodeType) {
      ...
      warn$2(`invalid template option: `, template);
      return NOOP;
    }
  }
  ...
  if (template[0] === "#") {
    ...
    if (!el) {
      warn$2(`Template element not found or is empty: ${template}`);
    }
...
var App = /*#__PURE__*/_export_sfc(_sfc_main$3, [['render',_sfc_render$3]]);
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", null, [
    _cache[2] || (_cache[2] = createBaseVNode("h1", null, "🛒 Carrinho de Compras", -1 /* HOISTED */)),
    _cache[3] || (_cache[3] = createBaseVNode("a", { href: "/product" }, "← Voltar para Lista", -1 /* HOISTED */)),
    ($setup.cartProducts.length > 0)
      ? (openBlock(), createElementBlock("table", _hoisted_1$2, [
          _cache[1] || (_cache[1] = createBaseVNode("thead", null, [
            createBaseVNode("tr", null, [
              createBaseVNode("th", null, "Produto"),
              createBaseVNode("th", null, "Quantidade"),
              createBaseVNode("th", null, "Preço"),
              createBaseVNode("th", null, "Total"),
              createBaseVNode("th", null, "Remover")
            ])
          ], -1 /* HOISTED */)),
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.cartProducts, (item) => {
              return (openBlock(), createElementBlock("tr", {
                key: item.id
              }, [
                createBaseVNode("td", null, toDisplayString(item.nome || 'Produto Desconhecido'), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString(item.quantidade || 0), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString($setup.formatCurrency(item.preco)), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString($setup.formatCurrency((item.preco || 0) * (item.quantidade || 0))), 1 /* TEXT */),
                createBaseVNode("td", null, [
                  createBaseVNode("button", {
                    class: "btn btn-danger",
                    onClick: $event => ($setup.removeItem(item.id))
                  }, "🗑️", 8 /* PROPS */, _hoisted_2$2)
                ])
              ]))
            }), 128 /* KEYED_FRAGMENT */))
          ])
        ]))
      : (openBlock(), createElementBlock("p", _hoisted_3$1, "Seu carrinho está vazio.")),
    ($setup.cartProducts.length > 0)
      ? (openBlock(), createElementBlock("button", {
          key: 2,
          class: "btn btn-success",
          onClick: _cache[0] || (_cache[0] = (...args) => ($setup.goToPay && $setup.goToPay(...args)))
        }, " Ir para Pagamento → "))
      : createCommentVNode("v-if", true)
  ]))
}
var Cart = /*#__PURE__*/_export_sfc(_sfc_main$2, [['render',_sfc_render$2]]);
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    _cache[3] || (_cache[3] = createBaseVNode("h1", null, "💳 Pagamento", -1 /* HOISTED */)),
    createVNode(_component_router_link, { to: "/checkout/cart" }, {
      default: withCtx(() => _cache[1] || (_cache[1] = [
        createTextVNode("← Voltar para o Carrinho")
      ])),
      _: 1 /* STABLE */
    }),
    ($setup.cartProducts.length > 0)
      ? (openBlock(), createElementBlock("table", _hoisted_1$1, [
          ...
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.cartProducts, (product) => {
              return (openBlock(), createElementBlock("tr", {
                key: product.id
              }, [
                createBaseVNode("td", null, toDisplayString(product.nome), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString(product.quantidade), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString($setup.formatCurrency(product.preco)), 1 /* TEXT */),
                createBaseVNode("td", null, toDisplayString($setup.formatCurrency(product.preco * product.quantidade)), 1 /* TEXT */)
              ]))
            }), 128 /* KEYED_FRAGMENT */))
          ])
        ]))
      : createCommentVNode("v-if", true),
    ($setup.cartProducts.length > 0)
      ? (openBlock(), createElementBlock("h3", _hoisted_2$1, "Total a Pagar: " + toDisplayString($setup.formatCurrency($setup.totalPrice)), 1 /* TEXT */))
      : (openBlock(), createElementBlock("p", _hoisted_3, "Não há itens no carrinho.")),
    ($setup.cartProducts.length > 0)
      ? (openBlock(), createElementBlock("button", {
          key: 3,
          class: "btn btn-primary",
          onClick: _cache[0] || (_cache[0] = (...args) => ($setup.finalizePurchase && $setup.finalizePurchase(...args)))
        }, " Finalizar Compra ✔ "))
      : createCommentVNode("v-if", true),
    ($setup.paymentStatus)
      ? (openBlock(), createElementBlock("p", {
          key: 4,
          class: normalizeClass({ 'text-success': $setup.paymentStatus === 'CONCLUIDO', 'text-danger': $setup.paymentStatus === 'FALHOU' })
        }, " Status do Pagamento: " + toDisplayString($setup.paymentStatus), 3 /* TEXT, CLASS */))
      : createCommentVNode("v-if", true)
  ]))
}
var Pay = /*#__PURE__*/_export_sfc(_sfc_main$1, [['render',_sfc_render$1]]);
...
var css_248z = "\n.success-container[data-v-9cad4ef9] {\r\n  text-align: center;\r\n  margin-top: 50px;\n}\n.button-group[data-v-9cad4ef9] {\r\n  margin-top: 20px;\n}\n.btn[data-v-9cad4ef9] {\r\n  padding: 10px 20px;\r\n  margin: 10px;\r\n  font-size: 16px;\n}\n.btn-primary[data-v-9cad4ef9] {\r\n  background-color: #007bff;\r\n  color: white;\r\n  border: none;\r\n  cursor: pointer;\n}\n.btn-danger[data-v-9cad4ef9] {\r\n  background-color: #dc3545;\r\n  color: white;\r\n  border: none;\r\n  cursor: pointer;\n}\n.btn[data-v-9cad4ef9]:hover {\r\n  opacity: 0.8;\n}\r\n";
...
const _hoisted_1 = { class: "success-container" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[4] || (_cache[4] = createBaseVNode("h1", null, "🥳 Compra Finalizada com Sucesso!", -1 /* HOISTED */)),
    createBaseVNode("p", null, [
      _cache[1] || (_cache[1] = createTextVNode("O status do seu pedido foi atualizado para ")),
      createBaseVNode("strong", null, toDisplayString($data.orderStatus), 1 /* TEXT */),
    ...
    createBaseVNode("div", _hoisted_2, [
      createVNode(_component_router_link, {
        ...
        default: withCtx(() => _cache[3] || (_cache[3] = [
          createTextVNode("🛍️ Continuar Comprando")
        ])),
        _: 1 /* STABLE */
      }),
      createBaseVNode("button", {
...
var Success = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render],['__scopeId',"data-v-9cad4ef9"]]);
